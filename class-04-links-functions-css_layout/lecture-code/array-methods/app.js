...
// concat
console.log(
    "concat will return a new array with the contents of the array that was called an and the array arguments"
);
var concatArray = numberArray.concat([33, 22, 11, 0]);
console.log(
    "numberArray.concat([33,22,11,0]) and stored new array in concatArray"
);
...
// join
console.log(
    'join will return a string of the items in the array separated by a provided string, by default "," is the separator'
);
...
console.log(
    "indexOf will return the first occurance of a specified value in an array, after a specified index(default 0)"
);
...
// slice and splice
console.log(
    "slice returns a new array composed of the contents between a start and end index, the default end index is array.length"
);
console.log("numberArray:               [" + numberArray.toString() + "]");
console.log(
    "numberArray.slice(3):      [" + numberArray.slice(3).toString() + "]"
);
console.log(
    "numberArray.slice(2, 6):   [" + numberArray.slice(2, 6).toString() + "]"
);
console.log("numberArray:               [" + numberArray.toString() + "]");
console.log("\n");

console.log(
    "splice removes and/or inserts an item or items at a specified index, changing the original array"
);
console.log("numberArray:               [" + numberArray.toString() + "]");
console.log(
    "numberArray.splice(2, 6):  [" + numberArray.splice(2, 6).toString() + "]"
);
console.log("numberArray:               [" + numberArray.toString() + "]");
console.log(
    "numberArray.splice(1):     [" + numberArray.splice(1).toString() + "]"
);
console.log("numberArray:               [" + numberArray.toString() + "]");
console.log("\n");
...
// fill
console.log(
    "fill will fill an array with a specified value between a start and end index"
);
numberArray = [2, 3, 4, 5, 5, 3, 23, 234, 4, 3, 234, 23, 4, 8];
console.log("numberArray:                 [" + numberArray.toString() + "]");
console.log(
    "numberArray.fill(0):         [" + numberArray.fill(0).toString() + "]"
);
console.log(
    "numberArray.fill(1, 3, 6):   [" + numberArray.fill(1, 3, 6).toString() + "]"
);